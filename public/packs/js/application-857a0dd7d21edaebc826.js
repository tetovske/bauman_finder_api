...
function changeCursor() {
  if ($('.main-page-subtitle').text().slice(-1) == '_') {
    ...
    $('.main-page-subtitle').text("".concat(oldText.substring(0, oldText.length - 1)));
  } else {
    oldText = $('.main-page-subtitle').text();
    $('.main-page-subtitle').text("".concat(oldText, "_"));
  }
}
...
__webpack_require__(/*! packs/animation */ "./app/javascript/packs/animation.js");

__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'packs/notifications'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
/******/ });
//# sourceMappingURL=application-857a0dd7d21edaebc826.js.map